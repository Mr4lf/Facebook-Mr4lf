...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Mr4lf  [Mr4lf]"$i"                            |"
echo $i" |"$pu" FACEBOOK :"$ku" Mr4lf"$i"                                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Nee210] [MrTr3vion] [Holilul Anwar]"$i"  |"
echo $i" |"$cy"            ~ [Akin.php] [Dfv47] [Accil]"$i"                 |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 083815983767"$i"                    |"
echo $i" |"$pu" Contack Gmail :"$ku" ayakkhanz01@gmail.com@gmail.com"$i"    |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"FR13ND8"$bi"]"$me"======"$bi"["$i""Pilih Nomornya Bangsad""$bi"]"
echo $me"¦"
read -p"└──# " pil
